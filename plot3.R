...
plot ( strptime (paste( as.character( two_days$Date ), two_days$Time ), format = "%Y-%m-%d %H:%M:%S"), as.numeric (as.character(two_days$Sub_metering_1)), xlab = "", ylab = "Energy sub metering", type = "l")
